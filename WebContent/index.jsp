...
<body style="height:100%;">
	...
	<div class="container">
		<div class="step_box fa">
			<div id="fa_1" class="step_item step_set">
		...
		<div class="main">
			...
			<div class="">
				<div class="choose">
					<div class="form-group" title="请导入特征文件">
						<label for="upfile">选择数据文件：</label>
					    <div class="input-group upfilewrap">
					        <input name="upfile" id="upfile" type="text" class="form-control" readonly="readonly">
					...
					<div class="txtcent mt30">
						...
						<button id="next" class="btn nextbtn" disabled="true" onclick="next_click()">下一步</button>
					</div>
				</div>
				<div>
